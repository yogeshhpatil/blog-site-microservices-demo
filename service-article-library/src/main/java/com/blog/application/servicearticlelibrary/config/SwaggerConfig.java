package com.blog.application.servicearticlelibrary.config;
...
//                    .paths(PathSelectors.ant("/v1/*"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(
                "Article Library Access REST API",
                "API expose some REST end points to access blog articles with comments.",
                "V 1.0",
                "Terms of service",
