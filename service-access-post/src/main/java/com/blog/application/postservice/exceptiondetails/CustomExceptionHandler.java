package com.blog.application.postservice.exceptiondetails;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlePostNotFoundException(Exception ex, WebRequest request) throws Exception {
    ...
    public ResponseEntity<Object> handleDBException(Exception ex, WebRequest request) throws Exception {
        ExceptionResponse  exceptionResponse = new ExceptionResponse(new Date(),"No Post Found "+ex.getLocalizedMessage(),request.getDescription(false));
        return new ResponseEntity(exceptionResponse, HttpStatus.NOT_FOUND);
    }
